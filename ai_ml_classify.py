...
# MAGIC     """
# MAGIC
# MAGIC     DATABRICKS_MODEL_URL = "https://<host>/serving-endpoints/databricks-gpt-5-1/invocations"
# MAGIC
# MAGIC     headers = {
...
# MAGIC
# MAGIC def ask_gpt_for_hyperparams(result):
# MAGIC     eda_prompt_stats = result
# MAGIC
...
# MAGIC
# MAGIC     Your output:
# MAGIC     - Return ONLY a JSON object (valid JSON, no trailing commas, no extra text) describing hyperparameter grids for several scikit-learn models like logistic regression, naive bayes,decision trees,randomn forest.
# MAGIC     - The keys of the top-level JSON should be model identifiers (for example "log_reg", "nb","dt","rf").
...
# MAGIC         }
# MAGIC         "rt":{
# MAGIC           "clf__n_estimators": [10, 50, 100], 
# MAGIC           "clf__max_depth": [3, 5, 7],
# MAGIC           "clf__min_samples_split": [2, 5, 7]
# MAGIC         }
# MAGIC     }
...
# MAGIC
# MAGIC         #resp.raise_for_status()
# MAGIC         hyper_params = ask_gpt_for_hyperparams(eda_stats)
...
# MAGIC
# MAGIC     else:
# MAGIC       model_file = "/Volumes/jahnavi/def/ai_ml_classify/models/main_yash_wine_training__quality__alcohol_density_ph_sulphates.joblib"
# MAGIC
# MAGIC       url = f"https://{host}/api/2.0/fs/files{model_file}"
# MAGIC       headers = {
